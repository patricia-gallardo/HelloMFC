...
BEGIN_MESSAGE_MAP(CHelloMFCApp, CWinAppEx)
...
// CHelloMFCApp customization load/save methods

void CHelloMFCApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CHelloMFCApp::LoadCustomState()
{
}

void CHelloMFCApp::SaveCustomState()
{
}
